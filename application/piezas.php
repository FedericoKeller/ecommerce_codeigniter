...
<input id="noclick" type="text" name="id" class="form-control" value="<?=$pieza[0]['id_pie']  ?>">
            ...
            <div class="col-md-12 form-group input-group required">
  <div class="input-group-prepend">
              ...
              <?php
                  ...
                  foreach ($piezas as $pieza) {
                    ...
                    $rutaEditar = base_url("user_authentication/guardar/{$pieza['id_pie']}");
                      $rutaBorrar = base_url("user_authentication/borrar?borrar={$pieza['id_pie']}");
                    echo "<tr>
                      <td>{$pieza['id_pie']}</td>
                      ...
                      <a href='{$rutaBorrar}' onclick='return confirm(\"¿Seguro que desea eliminar esta pieza?\")' class='btn btn-danger'><i class='fas fa-trash'></i></a>
                      </td>
                        </tr>
