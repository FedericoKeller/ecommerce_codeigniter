          ...
          <ul class="nav navbar-nav">
            <li class="dropdown tasks-menu">
              ...
              <ul class="dropdown-menu">
                <li class="header"> Último inicio de sesión:
                  <i class="fa fa-clock-o"></i>
                  <?= empty($last_login) ? : $last_login; ?>
                </li>
              </ul>
            </li>
                ...
                <li class="user-footer">
                  <div class="pull-left">
                    <a href="<?php echo base_url(); ?>userEdit" class="btn btn-default btn-flat">
                      <i class="fa fa-key"></i> Configuración </a>
                  </div>
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <?php
            ...
            <li class="treeview">
              <a href="<?php echo base_url(); ?>piezas">
                <i class="fa fa-wrench"></i>
                <span>Piezas</span>
              </a>
            </li>
            <li class="treeview">
              <a href="<?php echo base_url(); ?>addNewPieza">
                <i class="fa fa-plus-circle"></i>
                <span>Agregar una pieza</span>
              </a>
            </li>
            <?php
            }
            ...
            ?>
              ...
              <li class="treeview">
                <a href="<?php echo base_url(); ?>salesListing">
            ...
            ?>
                <li class="treeview">
                  ...
                  <li class="treeview">
                    <a href="<?php echo base_url(); ?>epiezas">
                      <i class="fa fa-wrench"></i>
                      <span>Piezas</span>
                    </a>
                  </li>
