...
<head>
  <meta charset="UTF-8">
  <title>ELEC | Panel de Gestión</title>
    ...
    <div class="login-box-body">
      ...
      <?php
        ...
        <form action="<?php echo base_url(); ?>createPasswordUser" method="post">
          ...
          <div class="form-group has-feedback">
            <input type="password" class="form-control" placeholder="Verificar contraseña" name="cpassword" required />
            <span class="glyphicon glyphicon-lock form-control-feedback"></span>
          </div>
          <div class="row">
            <div class="col-xs-8">
            ...
            <!-- /.col -->
            <div class="col-xs-4">
              <input type="submit" class="btn btn-primary btn-block btn-flat" value="Guardar" />
            </div>
            <!-- /.col -->
          </div>
        </form>
