...
?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <i class="fa fa-users"></i> Gestión de tareas
                <small>Añadir / Editar tarea</small>
            </h1>
        </section>
                ...
                <div class="col-md-8">
                    ...
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">Ingrese la información de la tareaz</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        ...
                        <form role="form" id="addNewTask" action="<?php echo base_url() ?>editTask" method="post" role="form">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="fname">Título de la tarea</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="role">Prioridad</label>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="comment">Descripción de la tarea</label>
