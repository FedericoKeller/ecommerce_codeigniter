                                ...
                                <div id="thumb" class="img-thumbnail">
                                    ...
                                    <div class="caption text-center">
                                        <h5><?php echo $row->nombre_pie;?></h5>
                                          <p style="font-size: 12px;"><?php echo $row->descripcion_pie;?><p>
                                        <div class="row">
                                            <div class="col-md-7">
                                              ...
                                              <div class="col-md-5">
                                                ...
                                                <h6>Stock: <?php echo number_format($row->cantidad_pie);?></h6>
                                                <?php else: ?>
                                                 <h6>Stock: <?php echo number_format($this->session->userdata['logged_in']['stock'][$count]["cantidad_pie"]);?></h6>
                                                  <?php endif; ?>
                                            </div>
                                            <div class="col-md-5">
